...
const BASE_URL = 'https://raw.githubusercontent.com/concon121/atom-aws-autocomplete-python/master/data/';
const SERVICES_URL = 'https://raw.githubusercontent.com/concon121/atom-aws-autocomplete-python/master/data/services.json';
...
class AdvancedProvider {
  ...
  findMatchingSuggestions(prefix) {
    ...
    return new Promise((resolve) => {
      ...
      var url;
      if (prefix.endsWith('.')) {
        url = BASE_URL + prefix.substr(0, prefix.length)
      } else {
        url = SERVICES_URL
      }
